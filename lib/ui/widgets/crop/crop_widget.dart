...
import 'package:lazycook/ui/widgets/crop/notifiers/crop_view_draw_notifier.dart';
import 'package:lazycook/ui/widgets/base_state.dart';
import 'package:lazycook/ui/widgets/crop/pointer/crop_ignore_pointer.dart';
import 'package:lazycook/ui/widgets/crop/painter/crop_mask.dart';
...
class CropWidget extends StatefulWidget {
  ...
  final num cropWidth;
  final num cropHeight;

  const CropWidget({Key key, this.controller, this.cropWidth, this.cropHeight})
      : super(key: key);
...
class _CropWidgetState extends BaseState<CropWidget> {
  ...
  void initState() {
    ...
    _cropCore = CropDrawNotifier(
      ...
      cropWidth: widget.cropWidth ?? width(250),
      cropHeight: widget.cropHeight ?? width(250),
      borderWidth: width(4),
